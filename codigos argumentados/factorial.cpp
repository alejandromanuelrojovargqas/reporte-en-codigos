...
int main() {
    ...
    printf("el factorial de %d es: %lld", n, factorial);
    
    // Finaliza la ejecución de la función 'main'. 
    // Retornar 0 es la convención estándar para indicar al sistema operativo que el programa terminó de forma exitosa.
    return 0;
}